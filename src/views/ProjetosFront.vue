<template>
  <div class="container">
    <div class="cards">
      <card-projetos
        imagem="\src\assets\img-projetos\MovieLib.png"
        titulo="MovieLib"
...
import CardProjetosInverso from "@/components/CardProjetosInverso.vue";

export default {
  components: { CardProjetos, CardProjetosInverso },
};
</script>
